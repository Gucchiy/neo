	...
	class VK_Media_Posts_BS4 {
		...
		public static function patterns() {
			...
			*/
			$patterns = array(
				'card'            => array(
					'label'             => __( 'Card', 'katawara' ),
					'class_posts_outer' => '',
				),
				'card-noborder'            => array(
					'label'             => __( 'Card Noborder', 'katawara' ),
					'class_posts_outer' => '',
				),
				'card-horizontal' => array(
					'label'             => __( 'Card Horizontal', 'katawara' ),
					'class_posts_outer' => '',
				),
				'media'           => array(
					'label'             => __( 'Media', 'katawara' ),
					'class_posts_outer' => 'media-outer',
				),
				'postListText'    => array(
					'label'             => _x( 'Text 1 Column', 'post list type', 'katawara' ),
		...
		public static function patterns_select_options( $selected ) {
			...
			$select_html   = '<option value="default">' . $system_name . __( 'default', 'katawara' ) . '</option>';
		...
		public static function label_names() {
			...
			$post_types_labels = array(
				'post' => __( 'Posts', 'katawara' ),
				'page' => __( 'Pages', 'katawara' ),
			);

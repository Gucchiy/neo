...
class VK_Media_Posts_BS4_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_name = $vk_media_post_prefix . __( 'Media Posts BS4', 'katawara' );
		parent::__construct(
			'media_posts_bs4',
			$widget_name,
			array( 'description' => __( 'It is a widget that displays the post list. Various shapes can be selected.', 'katawara' ) )
		);
	}
	...
	public static function widget_title( $instance ) {
		if ( isset( $instance['title'] ) ) {
			...
			$title = __( 'Recent Posts', 'katawara' );
		}
		return $title;
	}
	...
	*/
	...
	public function form( $instance ) {
		...
		<div class="admin-custom-section">
			<h2 class="admin-custom-h2"><?php esc_html_e( 'Display conditions', 'katawara' ); ?></h2>

			<h3 class="admin-custom-h3"><?php esc_html_e( 'Display post types', 'katawara' ); ?></h3>
			<?php
			// Post Type Check Box.
			$args = array(
			...
			<h3 class="admin-custom-h3">
				<label for="<?php echo esc_attr( $this->get_field_id( 'terms' ) ); ?>"><?php esc_html_e( 'Category(Term) ID', 'katawara' ); ?></label>
			</h3>
			...
			<br />
			<?php
			esc_html_e( 'If you need filtering by category(term), add the category ID separate by ",".', 'katawara' );
			echo '<br/>';
			esc_html_e( 'If empty this area, I will do not filtering.', 'katawara' );
			echo '<br/><br/>';
			?>
			...
			?>
			<h3 class="admin-custom-h3">
				<label for="<?php echo esc_attr( $this->get_field_id( 'count' ) ); ?>"><?php esc_html_e( 'Display count', 'katawara' ); ?></label>
			</h3>
			...
			?>
			<h3 class="admin-custom-h3">
				<label for="<?php echo esc_attr( $this->get_field_id( 'offset' ) ); ?>"><?php esc_html_e( 'Offset count', 'katawara' ); ?></label>
			</h3>
		...
		<div class="admin-custom-section">
			...
			<h2 class="admin-custom-h2"><?php esc_html_e( 'Display type and columns', 'katawara' ); ?></h2>

			<h3 class="admin-custom-h3">
				<?php echo esc_html_e( 'Display type', 'katawara' ); ?>
			</h3>
			...
			*/
			...
			<h3 class="admin-custom-h3">
				<?php esc_html_e( 'Columns', 'katawara' ); ?>
			</h3>

			<p><?php esc_html_e( 'Please input column count to under the range of 1 to 4.', 'katawara' ); ?></p>
			...
			foreach ( $sizes as $key => $value ) {
				...
				echo '<label for="' . esc_attr( $this->get_field_id( $field ) ) . '">' . esc_html( sprintf( __( 'Column ( Screen size : %s )', 'katawara' ), $value['label'] ) ) . '</label>';
		...
		?>
		<div class="admin-custom-section">
			<h2 class="admin-custom-h2"><?php esc_html_e( 'Order Option', 'katawara' ); ?></h2>
			<h3 class="admin-custom-h3"><?php esc_html_e( 'Order by', 'katawara' ); ?></h3>
			...
			<h3 class="admin-custom-h3"><?php esc_html_e( 'Order', 'katawara' ); ?></h3>
		...
		<div class="admin-custom-section">
			...
			<h2 class="admin-custom-h2"><?php esc_html_e( 'Display item', 'katawara' ); ?></h2>

			<?php
			$items = array(
				'display_image'              => __( 'Image', 'katawara' ),
				'display_image_overlay_term' => __( 'Term name', 'katawara' ),
				'display_excerpt'            => __( 'Excerpt', 'katawara' ),
				'display_date'               => __( 'Date', 'katawara' ),
				'display_new'                => __( 'New mark', 'katawara' ),
				'display_taxonomies'         => __( 'Taxonomies', 'katawara' ),
				'display_btn'                => __( 'Button', 'katawara' ),
			);
			...
			<h3 class="admin-custom-h3"><?php esc_html_e( 'New mark option', 'katawara' ); ?></h3>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'new_date' ) ); ?>">
				<?php esc_html_e( 'Number of days to display the new post mark', 'katawara' ); ?>
			</label>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'new_text' ) ); ?>">
				<?php esc_html_e( 'New mark text', 'katawara' ); ?>
			</label>
			...
			<h3 class="admin-custom-h3">
					<?php esc_html_e( 'Button option', 'katawara' ); ?>
			</h3>

			<label for="<?php echo esc_attr( $this->get_field_id( 'btn_text' ) ); ?>">
				<?php esc_html_e( 'Button text', 'katawara' ); ?>
			</label>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'btn_align' ) ); ?>">
				<?php esc_html_e( 'Button align', 'katawara' ); ?>
			</label>
			<select id="<?php echo esc_attr( $this->get_field_name( 'btn_align' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'btn_align' ) ); ?>" class="admin-custom-input">
				...
				$btn_aligns = array(
					'text-left'   => array(
						'label' => __( 'Left', 'katawara' ),
					),
					'text-center' => array(
						'label' => __( 'Center', 'katawara' ),
					),
					'text-right'  => array(
						'label' => __( 'Right', 'katawara' ),
					),
				);

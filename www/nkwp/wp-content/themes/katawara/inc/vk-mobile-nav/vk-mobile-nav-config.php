...
if ( ! class_exists( 'Vk_Mobile_Nav' ) ) {
	...
	// add_action( 'katawara_header_before', array( 'Vk_Mobile_Nav', 'menu_set_html' ) );

	global $vk_mobile_nav_inline_style_handle;
	$vk_mobile_nav_inline_style_handle = 'katawara-design-style';

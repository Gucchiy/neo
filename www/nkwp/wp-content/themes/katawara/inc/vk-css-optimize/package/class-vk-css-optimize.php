	...
	class VK_CSS_Optimize {
		...
		public static function customize_register( $wp_customize ){
			...
			$wp_customize->add_section(
				'css_optimize', array(
					'title'    => $prefix_customize_panel . __( 'CSS Optimize ( Speed up ) Settings', 'katawara' ),
					'priority' => 450,
				)
			);
			...
			$wp_customize->add_control(
				new Custom_Html_Control(
					...
					'tree_shaking_title',
					array(
						'label'            => __( 'Tree shaking', 'katawara' ),
						'section'          => 'css_optimize',
						'type'             => 'text',
						'custom_title_sub' => '',
						// 'custom_html'      => __( 'Move part of CSS and JS to the footer to improve display speed.', 'katawara' ),
					)
				)
			);
			...
			$wp_customize->add_control(
				'vk_css_optimize_options[tree_shaking]',
				array(
					'label'    		=> __( 'Tree shaking activation settings', 'katawara' ),
					'section'  		=> 'css_optimize',
					'settings' 		=> 'vk_css_optimize_options[tree_shaking]',
					'type'     		=> 'select',
					'description'	=> __( 'Output only the main CSS of the page inline', 'katawara' ),
					'choices'  => array(
						''			=> __( 'Nothing to do', 'katawara' ),
						'active'	=> __( 'Active Tree shaking (Recomend)', 'katawara' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				'vk_css_optimize_options[tree_shaking_class_exclude]',
				array(
					'label'       => __( 'Exclude class of Tree shaking', 'katawara' ),
					'section'     => 'css_optimize',
					'settings'    => 'vk_css_optimize_options[tree_shaking_class_exclude]',
					'type'        => 'textarea',
					'description' => __( 'If you choose "Active Tree shaking" that delete the useless css.If you using active css class that please fill in class name. Ex) btn-active,slide-active,scrolled', 'katawara' ),
				)
			);
			...
			$wp_customize->add_control(
				'vk_css_optimize_options[preload]',
				array(
					'label'       => __( 'Preload CSS activation settings', 'katawara' ),
					'section'     => 'css_optimize',
					'settings'    => 'vk_css_optimize_options[preload]',
					'description' => __( 'Preload css except for critical css', 'katawara' ),
					'type'        => 'select',
					'choices'  => array(
						''   	 	=> __( 'Nothing to do', 'katawara' ),
						'active'    => __( 'Active Preload CSS (Recomend)', 'katawara' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				'vk_css_optimize_options[preload_handle_exclude]',
				array(
					'label'       => __( 'Exclude class of Preload CSS', 'katawara' ),
					'section'     => 'css_optimize',

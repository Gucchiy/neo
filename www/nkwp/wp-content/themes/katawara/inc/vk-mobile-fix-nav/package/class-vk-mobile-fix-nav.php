...
if ( ! class_exists( 'Vk_Mobile_Fix_Nav' ) ) {
	...
	class Vk_Mobile_Fix_Nav {
		...
		public static function widgets_init() {
			register_sidebar(
				array(
					'name'          => __( 'Widget area of mobile fix nav', 'katawara' ),
		...
		public function vk_mobil_fix_nav_customize_register( $wp_customize ) {
			...
			$wp_customize->add_section(
				...
				array(
					'title'    => $vk_mobile_fix_nav_prefix . __( 'Mobile Fix Nav', 'katawara' ),
			...
			$wp_customize->add_control(
				'vk_mobil_fix_nav_options[hidden]',
				array(
					'label'    => __( 'Do not display Mobile Fix Nav', 'katawara' ),
			...
			$wp_customize->add_control(
				new MobileNav_Custom_Html(
					...
					'nav_title_widget',
					array(
						'label'            => __( 'Mobile Fix Nav Widget Area', 'katawara' ),
						'section'          => 'vk_mobil_fix_nav_setting',
						'type'             => 'text',
						'custom_title_sub' => '',
						'custom_html'      => '',
			...
			$wp_customize->add_control(
				'vk_mobil_fix_nav_options[widget_padding]',
				array(
					'label'    => __( 'Add Widget Area Padding', 'katawara' ),
					'section'  => 'vk_mobil_fix_nav_setting',
			...
			$wp_customize->add_control(
				new MobileNav_Custom_Html(
					...
					'nav_title_0',
					array(
						'label'            => __( 'Add menu open and close button', 'katawara' ),
						'section'          => 'vk_mobil_fix_nav_setting',
						'type'             => 'text',
						'custom_title_sub' => '',
						'custom_html'      => '',
			...
			$wp_customize->add_control(
				'vk_mobil_fix_nav_options[add_menu_btn]',
				array(
					'label'       => __( 'Add menu open and close button to first.', 'katawara' ),
					'section'     => 'vk_mobil_fix_nav_setting',
					'settings'    => 'vk_mobil_fix_nav_options[add_menu_btn]',
					'type'        => 'checkbox',
					'description' => __( '* When using Font Awesome 5 SVG, the icon does not switch at menu open.', 'katawara' ),
				)
			);
			...
			for ( $i = 1; $i <= $menu_num; $i ++ ) {
				...
				$wp_customize->add_control(
					new MobileNav_Custom_Html(
						...
						'nav_title_' . $i,
						array(
							'label'            => __( 'Fix Navi button', 'katawara' ) . ' [ ' . $i . ' ]',
							'section'          => 'vk_mobil_fix_nav_setting',
							'type'             => 'text',
							'custom_title_sub' => '',
							'custom_html'      => '',
				...
				$wp_customize->add_control(
					'link_icon_' . $i,
					array(
						'label'       => __( 'Icon font class name:', 'katawara' ),
						'section'     => 'vk_mobil_fix_nav_setting',
						'settings'    => 'vk_mobil_fix_nav_options[link_icon_' . $i . ']',
						'type'        => 'text',
						'description' => __( 'To choose your favorite icon, and enter the class.', 'katawara' ) . '<br>' . $description,
					)
				);
				...
				$wp_customize->add_control(
					'link_url_' . $i,
					array(
						'label'       => __( 'Link URL:', 'katawara' ),
						'section'     => 'vk_mobil_fix_nav_setting',
						'settings'    => 'vk_mobil_fix_nav_options[link_url_' . $i . ']',
						'type'        => 'text',
						'description' => __( 'Ex', 'katawara' ) . ') https://vccw.text/',
					)
				);
				...
				$wp_customize->add_control(
					'vk_mobil_fix_nav_options[link_blank_' . $i . ']',
					array(
						'label'    => __( 'Open link new tab.', 'katawara' ),
						'section'  => 'vk_mobil_fix_nav_setting',
				...
				$wp_customize->add_control(
					'event_' . $i,
					array(
						'label'       => __( 'Click event:', 'katawara' ),
						'section'     => 'vk_mobil_fix_nav_setting',
						'settings'    => 'vk_mobil_fix_nav_options[event_' . $i . ']',
						'type'        => 'text',
						'description' => __( 'Ex', 'katawara' ) . ") ga('send', 'event', 'Videos', 'play', 'Fall Campaign');",
					)
				);
				...
				$wp_customize->add_control(
					new MobileNav_Custom_Html(
						...
						'nav_common',
						array(
							'label'            => __( 'Navi Common Settings', 'katawara' ),
							'section'          => 'vk_mobil_fix_nav_setting',
							'type'             => 'text',
							'custom_title_sub' => '',
							'custom_html'      => '',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'current_color',
					array(
						'label'    => __( 'Current Color:', 'katawara' ),
						'section'  => 'vk_mobil_fix_nav_setting',

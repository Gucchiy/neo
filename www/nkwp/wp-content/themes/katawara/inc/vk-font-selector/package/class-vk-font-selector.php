...
if ( ! class_exists( 'Vk_Font_Selector_Customize' ) ) {
	...
	class Vk_Font_Selector_Customize {
		...
		public static function fonts_array() {
			$fonts_array = array(
				''                      => array(
					'label'       => __( 'Unspecified', 'katawara' ),
					'font-family' => '',
				),
				'mincho'                => array(
					'label'       => __( 'Mincho', 'katawara' ),
					'font-family' => 'Hiragino Mincho ProN,"游明朝",serif',
				),
				'hira-kaku'             => array(
					'label'       => __( 'Hiragino Kaku Gothic', 'katawara' ),
				...
				'yu-gothic'             => array(
					'label'       => __( 'Yu Gothic', 'katawara' ),
					'font-family' => '"游ゴシック Medium","Yu Gothic Medium","游ゴシック体",YuGothic,"ヒラギノ角ゴ ProN W3", Hiragino Kaku Gothic ProN,sans-serif',
				),
				'meiryo'                => array(
					'label'       => __( 'Meiryo', 'katawara' ),
					'font-family' => '"メイリオ",Meiryo,"ヒラギノ角ゴ ProN W3", Hiragino Kaku Gothic ProN,sans-serif',
				),
				'san-francisco'         => array(
					'label'       => __( 'San Francisco', 'katawara' ),
		...
		public static function register( $wp_customize ) {
			...
			$wp_customize->add_section(
				...
				array(
					'title'    => $vk_font_selector_prefix . __( 'Font Setting', 'katawara' ),
			...
			$html  = '<ul>';
			$html .= '<li>' . __( 'If you want to apply the same font on mobile devices, please select web font (Google Fonts).', 'katawara' ) . '</li>';
			$html .= '<li>' . __( 'The web font (Google Fonts) loads the font data, so the display will be slightly late.', 'katawara' ) . '</li>';
			$html .= '</ul>';
			...
			foreach ( $targets as $key => $label ) {
				...
				$wp_customize->add_control(
					'vk_font_selector[' . $key . ']',
					array(
						'label'    => __( $label . ':', 'katawara' ),
						'section'  => 'vk_font_selector_related_setting',
						'settings' => 'vk_font_selector[' . $key . ']',
						'type'     => 'select',
						'choices'  => $choices,
					// 'choices'  => array(
					// 'mincho' => __( 'Mincho', 'katawara' ),
					// 'gothic' => __( 'Gothic', 'katawara' ),
					// ),
					)
				);
			}

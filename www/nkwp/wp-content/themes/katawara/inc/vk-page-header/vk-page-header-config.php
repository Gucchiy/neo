...
if ( ! class_exists( 'Vk_Page_Header' ) ) {
	...
	$customize_setting_prefix = katawara_get_prefix_customize_panel();

	global $vk_page_header_use_type;
	$vk_page_header_use_type = true;

	global $customize_section_priority;
	$customize_section_priority = 530;

	global $vk_page_header_output_class;
	$vk_page_header_output_class = '.p-page-header';

	global $vk_page_header_inner_class;
	$vk_page_header_inner_class = '.p-page-header .l-container';
	...
	$vk_page_header_enqueue_handle_style = 'katawara-design-style';

}

// var_dump($vk_page_header_default_bg_url);

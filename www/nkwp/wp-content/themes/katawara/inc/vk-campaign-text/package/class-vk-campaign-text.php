	...
	class VK_Campaign_Text {
		...
		public static function resister_customize( $wp_customize ) {
			...
			$wp_customize->add_section(
				...
				array(
					'title'    => $vk_campaign_text_prefix . __( 'Campaign Text', 'katawara' ),
					'priority' => 513,
				)
			);
			...
			$wp_customize->add_control(
				'vk_campaign_text[display]',
				array(
					'label'    => __( 'Display Campaign Text', 'katawara' ),
					'section'  => 'vk_campaign_text_setting',
					'settings' => 'vk_campaign_text[display]',
					'type'     => 'select',
					'choices'  => array(
						'hide'               => __( 'Hide', 'katawara' ),
						'show_in_front_page' => __( 'Show in Front Page', 'katawara' ),
						'show_in_full_page'  => __( 'Show in Full Page', 'katawara' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				'vk_campaign_text[display_position]',
				array(
					'label'       => __( 'Display Position', 'katawara' ),
					'section'     => 'vk_campaign_text_setting',
					'settings'    => 'vk_campaign_text[display_position]',
					'type'        => 'select',
					'choices'     => $choices,
					'description' => __( '* If you save and reload after making changes, the position of campaign text will change.', 'katawara' ),
				)
			);
			...
			$wp_customize->add_control(
				'vk_campaign_text[main_text]',
				array(
					'label'    => _x( 'Text', 'campaign text', 'katawara' ),
					'section'  => 'vk_campaign_text_setting',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'vk_campaign_text[button_text_color]',
					array(
						'label'    => __( 'Button Text Color', 'katawara' ),
						'section'  => 'vk_campaign_text_setting',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'vk_campaign_text[button_background_color]',
					array(
						'label'    => __( 'Button Background Color', 'katawara' ),
						'section'  => 'vk_campaign_text_setting',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'vk_campaign_text[button_text_hover_color]',
					array(
						'label'    => __( 'Button Text Hover Color', 'katawara' ),
						'section'  => 'vk_campaign_text_setting',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'vk_campaign_text[button_background_hover_color]',
					array(
						'label'    => __( 'Button Background Hover Color', 'katawara' ),
						'section'  => 'vk_campaign_text_setting',
			...
			$wp_customize->add_control(
				'vk_campaign_text[link_target]',
				array(
					'label'    => __( 'Open in New Tab', 'katawara' ),
					'section'  => 'vk_campaign_text_setting',
